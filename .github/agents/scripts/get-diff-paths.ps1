...
#
# Usage:
#   .\get-diff-paths.ps1 --files "src/Klikety/Grid"
#   .\get-diff-paths.ps1 --diff "src/Klikety/Grid/GridCalculator.cs","src/Klikety/Grid/GridCell.cs"
#   .\get-diff-paths.ps1 --files "src/Klikety/Grid","src/Klikety/Navigation/ArrowNavigator.cs"
