...
- [x] 2.1a Extract `KeyLabelResolver` shared helper [after: 1.4] `S`
...
- [x] 2.1c Extract `IModeSession` + `UniformGridSession` skeleton [after: 2.1b] `M`
...
- [x] 2.2 Mode factory [after: 2.1d] `M`
